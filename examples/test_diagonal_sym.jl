...
Ψ, ρL, ρR, E, e, normgrad, numfg, history = groundstate_diagonal_sym(H, Ψ, V, Ss; optalg = alg1, linalg = linalg)
# αs,fs, dfs1, dfs2 = groundstate_diagonal_sym(H, Ψ, V, Ss; optalg = alg1, linalg = linalg)
