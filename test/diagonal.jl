...
@load "benchmark_mu=$(μ)_c=$(c)_c12=$(c12)_D=8" Ψs Ψ0s Es histories
...
for i in 1:50
    ...
    # @save "data_mu=$(μ)_c=$(c)_c12=$(c12)_D=64" Ψ ρR E e normgrad numfg history
end

@save "benchmark_mu=$(μ)_c=$(c)_c12=$(c12)_D=8_no_prec" Ψ2s E2s histories2
